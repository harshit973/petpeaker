 ...
 */
@WebServlet("/admin/breed/highlights/add")
public class adminbreedhighlightadd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			PreparedStatement ps=new database().connect().prepareStatement("insert into breedhighlights(breed,highlight) values(?,?)");
			String[] names=new String[] {"breed","highlights"};
			int i=1;
			for(String j:names) {

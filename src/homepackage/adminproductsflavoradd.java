 ...
 */
@WebServlet("/admin/products/flavor/add")
public class adminproductsflavoradd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			PreparedStatement ps=new database().connect().prepareStatement("insert into flavor(pid,flavor) values(?,?)");
			String[] names=new String[] {"pdata","flavor"};
			int i=1;
			for(String j:names) {

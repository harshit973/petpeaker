 ...
 */
@WebServlet("/admin/products/purchase/add")
public class adminproductpurchaseadd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			PreparedStatement ps=new database().connect().prepareStatement("insert into purchase(uid,pid,purchasedate,deliverydate) values(?,?,?,?)");
			String[] names=new String[] {"user","product","purchase date","delivery date"};
			int i=1;
			for(String j:names) {

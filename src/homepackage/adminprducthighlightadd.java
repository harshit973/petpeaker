 ...
 */
@WebServlet("/admin/product/highlights/add")
public class adminprducthighlightadd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			PreparedStatement ps=new database().connect().prepareStatement("insert into highlights(pid,highlight) values(?,?)");
			String[] names=new String[] {"pid","highlights"};
			int i=1;
			for(String j:names) {

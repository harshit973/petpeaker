...
<div style="margin:20px 30px">
	<div style="overflow:auto;">
		<p style="font-size:20px">Add <%=request.getAttribute("modal") %></p>
	</div>
	<div style="overflow:auto;">
	<form method="POST" onsubmit=" return validate()" action="">
		...
		<div style="display:flex">
			...
			<% if(i.get("mode").toString().equals("0")){ %>
				<div class="element">
					<input autocomplete="off" name="<%=i.get("name") %>" required=<%=(i.containsKey("null"))?"false":"true" %>  type="<%=i.get("type") %>" />			
					<p style="color:red;margin:5px 0;font-size:15px;display:none">This field is required</p>
				</div>				
			<% }else if(i.get("mode").toString().equals("1")){ %>
				<div  class="element">
				<select required="true" name="<%=i.get("name") %>">

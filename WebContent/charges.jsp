...
.pcard{
	border:1px solid gray;border-radius:0.2em;width:270px;padding:10px;margin:0 10px;
}
...
<% if(data.size()>0){ %>
<div style="text-align:center;overflow:auto;margin:40px auto;width:50%">
...
<div style="margin:20px 10px;display:flex;justify-content:center;padding:10px 0px;">

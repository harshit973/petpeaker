...
<head>
    ...
    *{
	...
	.filterdrop{
		position:fixed;bottom:0;width:100%;height:0;background-color:white;z-index:777;transition:0.5s ease-in-out;overflow-y:hidden
	}    
    .slider .thumb{
	    position:absolute;
    	width:15px;
...
<div class="filterdrop" >
    ...
    <div style="display:flex;box-sizing:border-box">
    	<div style="width: 100%;background-color:white;padding:10px;overflow:auto;box-sizing:border-box;">
